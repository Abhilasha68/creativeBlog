...
if(isset($_POST["submit"]))
{
    ...
    $query = "INSERT INTO `contact` (`cname`, `cemail`, `cphone`, `cmessage`) values('$name', '$email', '$phone', '$message')";

    if(!mysqli_query($query))
    {
        echo "Error inserting values".mysqli_error();
    }
    else
    {
...
<head>
    ...
    <title>Creative Unbound - Contact</title>
