    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="contailner-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="index.php">Creative Unbound</a>
            </div>
                      ...
                      echo '<div class="row">';
                       echo '<div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">';
                        ...
                        echo '</h1>';
                            echo $post->content;
                        // echo $post->title;
                         //echo '<h2 class="subheading">Problems look mighty small from 150 miles up</h2>';
                         echo '<span class="meta">Posted by <a href="#">Start Bootstrap</a> on August 24, 2014</span>';
                        echo '</div>';
                      echo '</div>';
                    echo '</div>';
                   echo '</div>';
